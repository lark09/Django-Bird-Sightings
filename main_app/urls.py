...
urlpatterns = [
    ...
    path('birds/<int:bird_id>/add_sighting/',
         views.add_sighting, name='add_sighting'),
    path('birds/<int:bird_id>/assoc_location/<int:location_id>/', 
         views.assoc_location, name='assoc_location'),
